...
describe('Service Tests', () => {
    describe('ChampionTag Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a ChampionTag', () => {
                service.create(new ChampionTag(null)).subscribe(received => {
            ...
            it('should update a ChampionTag', () => {
                service.update(new ChampionTag(123)).subscribe(received => {
            ...
            it('should delete a ChampionTag', () => {
